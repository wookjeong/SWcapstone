...
ctrl_cmd = ['forward', 'backward', 'left', 'right', 'stop', 'auto', 'home', 'manual', 'x+', 'cameraleft', 'y+', 'y-', 'xy_home']
...
if __name__ == "__main__":
	...
	collision = multiprocessing.Value('i',0)
	procs.append(multiprocessing.Process(target=jeongwook.handle_video,args=(value,)))
